...
// Site footer for the Home tab and its content pages. Suppressed on Journal and Wallet — those
// routes are full-height dashboards (sidebar + content), and a marketing footer under them just
// eats vertical space. Same pattern as HomeNav.
