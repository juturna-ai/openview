...
// Lucide glyphs, inlined — same approach (and licence note) as journal/icons.tsx. Reach imports
// these from `lucide-react`; pulling the package in for a handful of icons would cost more than the
// paths themselves. Names match the upstream Lucide icon names.
...
const PATHS: Record<string, React.ReactNode> = {
  ...
  radar: (
    <>
      <path d="M19.07 4.93A10 10 0 0 0 6.99 3.34M4 6h.01M2.29 9.62A10 10 0 1 0 21.31 8.35M16.24 7.76A6 6 0 1 0 8.23 16.67M12 18h.01M17.99 11.66A6 6 0 0 1 15.77 16.67" />
