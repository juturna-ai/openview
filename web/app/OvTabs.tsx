...
export default function OvTabs({ active }: { active?: 'home' | 'openview' | 'journal' | 'assets' | 'wallet' }) {
  ...
  return (
    <div className="ov-tabs">
      ...
      <Link href="/home/assets" className={'ov-tab' + (current === 'assets' ? ' active' : '')}>Assets</Link>
